...
@can('eProviders.index')
    <li class="nav-item has-treeview {{ (Request::is('eProvider*') || Request::is('requestedEProviders*') || Request::is('galleries*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*') ) && !Request::is('eProviderPayouts*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ (Request::is('eProvider*') || Request::is('requestedEProviders*') || Request::is('galleries*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*')) && !Request::is('eProviderPayouts*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            @can('eProviderTypes.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eProviderTypes*') ? 'active' : '' }}"
                       href="{!! route('eProviderTypes.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list-alt"></i>@endif
                        <p>{{trans('lang.e_provider_type_plural')}}</p></a>
                </li>
            @endcan
            <li class="nav-item">
                <a class="nav-link {{ Request::is('eProviders*') ? 'active' : '' }}"
                   href="{!! route('eProviders.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.e_provider_plural')}}</p></a>
            </li>
            @can('requestedEProviders.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('requestedEProviders*') ? 'active' : '' }}"
                       href="{!! route('requestedEProviders.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list-alt"></i>@endif
                        <p>{{trans('lang.requested_e_providers_plural')}}</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('experiences*') ? 'active' : '' }}"
                       href="{!! route('experiences.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-briefcase"></i>@endif<p>{{trans('lang.experience_plural')}}</p>
                    </a>
                </li>
            @endcan
            @can('availabilityHours.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('availabilityHours*') ? 'active' : '' }}"
                       href="{!! route('availabilityHours.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-business-time"></i>@endif
                        <p>{{trans('lang.availability_hour_plural')}}</p></a>
                </li>
            @endcan
            @can('addresses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('addresses*') ? 'active' : '' }}"
                       href="{!! route('addresses.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-map-marked-alt"></i>@endif<p>{{trans('lang.address_plural')}}</p>
                    </a>
                </li>
            @endcan
        </ul>
...
{{--@can('packages.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('packages*') ? 'active' : '' }}" href="{!! route('packages.index') !!}">@if($icons)
                <i class="nav-icon fas fa-cube"></i>@endif<p>{{trans('lang.packages_plural')}}</p></a>
    </li>
@endcan--}}
...
@can('eServices.index')
    <li class="nav-item has-treeview {{ Request::is('eServices*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('eServiceReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{  Request::is('eServices*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('eServiceReviews*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            @can('eServices.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eServices*') ? 'active' : '' }}"
                       href="{!! route('eServices.index') !!}">@if($icons)
            ...
            @can('optionGroups.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('optionGroups*') ? 'active' : '' }}"
                       href="{!! route('optionGroups.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-plus-square"></i>@endif
            ...
            @can('eServiceReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eServiceReviews*') ? 'active' : '' }}"
                       href="{!! route('eServiceReviews.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-comments"></i>@endif
                        <p>{{trans('lang.e_service_review_plural')}}</p></a>
                </li>
            @endcan
...
<li class="nav-item has-treeview {{ Request::is('bookings*') || Request::is('bookingStatuses*') || Request::is('deliveryAddresses*')? 'menu-open' : '' }}">
    <a href="#"
       class="nav-link {{ Request::is('bookings*') || Request::is('bookingStatuses*') || Request::is('deliveryAddresses*')? 'active' : '' }}"> @if($icons)
    ...
    <ul class="nav nav-treeview">
        ...
        @can('bookings.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('bookings*') ? 'active' : '' }}"
                   href="{!! route('bookings.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-calendar-check"></i>@endif<p>{{trans('lang.booking_plural')}}</p></a>
            </li>
        @endcan
        @can('bookingStatuses.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('bookingStatuses*') ? 'active' : '' }}"
                   href="{!! route('bookingStatuses.index') !!}">@if($icons)
...
@can('coupons.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('coupons*') ? 'active' : '' }}"
           href="{!! route('coupons.index') !!}">@if($icons)
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('faqCategories*') ? 'active' : '' }}"
                       href="{!! route('faqCategories.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-folder-open"></i>@endif
                        <p>{{trans('lang.faq_category_plural')}}</p></a>
                </li>
            @endcan
...
@can('payments.index')
    <li class="nav-item has-treeview {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('eProviderPayouts*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('eProviderPayouts*') ? 'active' : '' }}"> @if($icons)
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('payments*') ? 'active' : '' }}"
                       href="{!! route('payments.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-check-alt"></i>@endif<p>{{trans('lang.payment_table')}}</p>
                    </a>
                </li>
            @endcan
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('paymentMethods*') ? 'active' : '' }}"
                       href="{!! route('paymentMethods.index') !!}">@if($icons)
                        ...
                        <p>{{trans('lang.payment_method_plural')}}</p></a>
                </li>
            @endcan
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('paymentStatuses*') ? 'active' : '' }}"
                       href="{!! route('paymentStatuses.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-file-invoice-dollar"></i>@endif
                        <p>{{trans('lang.payment_status_plural')}}</p></a>
                </li>
            @endcan
            ...
            @can('eProviderPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eProviderPayouts*') ? 'active' : '' }}"
                       href="{!! route('eProviderPayouts.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-bill-wave"></i>@endif
                        <p>{{trans('lang.e_provider_payout_plural')}}</p></a>
                </li>
            @endcan
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('walletTransactions*') ? 'active' : '' }}"
                       href="{!! route('walletTransactions.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-list-alt"></i>@endif
                        <p>{{trans('lang.wallet_transaction_plural')}}</p></a>
                </li>
            @endcan
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('settings/currencies*') ? 'active' : '' }}"
                       href="{!! route('currencies.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-dollar-sign"></i>@endif<p>{{trans('lang.currency_plural')}}</p>
                    </a>
                </li>
            @endcan
            @can('taxes.index')
            ...
            <li class="nav-item">
                <a href="{!! url('settings/payment/payment') !!}"
                   class="nav-link {{  Request::is('settings/payment*') ? 'active' : '' }}">
                    @if($icons)<i class="nav-icon fas fa-credit-card"></i> @endif
            ...
            <li class="nav-item">
                <a href="{!! url('settings/app/notifications') !!}"
                   class="nav-link {{  Request::is('settings/app/notifications*') ? 'active' : '' }}">
                    @if($icons)<i class="nav-icon fas fa-bell"></i> @endif
