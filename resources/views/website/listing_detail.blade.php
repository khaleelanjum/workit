                    ...
                    <div class="col-md-12">
                        <div class="simple_slick_carousel_block utf_dots_nav">
                            ...
                            <div class="utf_carousel_item"><a href="listings_single_page_1.html"
                                    ...
                                    <div class="utf_listing_item"><img src="{{asset($service["url"])}}" alt="">
                                        <span
                                        ...
                                        <div class="utf_listing_item_content">
                                            ...
                                            <span class="utf_meta_listing_price"><i
                                                        class="fa fa-tag"></i> {{ $service['price'] - $service['discount_price'] }}</span>
                                       ...
                                       <?php
                                            ...
                                            $no=  DB::table('e_providers')->where('id', $service->e_provider_id)->get();;
                                       ?>
                                            ...
                                            <span><i class="sl sl-icon-location"></i> {{$no[0]->description}}</span>
                                            <span><i class="sl sl-icon-phone"></i>  {{$service->mobile_number}}</span>

                                        </div>
                                    </div>
                                    <div class="utf_star_rating_section" data-rating="4.5">
                                        <div class="utf_counter_star_rating">{{number_format((float)$service_detail["rate"], 1, '.', '')}}
                                            / ({{$service_detail["total_reviews"]}} Reviews)</div>
